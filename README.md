...
| 4.8 | [7. Reverse Integer](https://leetcode.com/problems/reverse-integer) note: return 0 if overflow above 2^31-1  or underflow below - 2^31 of the reversed value |
